...
//    static const int THREAD_END_OF_WORK = 0;
    static const int THREAD_NO_ERROR = 0;
...
//    static const int THREAD_DATABASE_NOT_OPEN = 2;
    ...
    static const int THREAD_LOST_QUERY_ERROR = 4;

    static const int CLASS_NO_ERROR = 0;
    static const int CLASS_NO_FREE_THREADS = 100;
};
